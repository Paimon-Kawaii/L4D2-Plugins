 ...
 * @Last Modified time: 2022-04-14 14:36:22
...
ConVar
    g_hAngelParty;//0=Disable, 1=Smoker, 2=Boomer, 3=Hunter,
                  //4=Spitter, 5=Jockey, 6=Charger, 7=Witch(Unsafe), 8=Tank
...
{
    if(g_hAngelParty.IntValue == 0 ||
        g_hAngelParty.IntValue == 7 ||
        g_hAngelParty.IntValue > 8)
...
{
    if(g_hAngelParty.IntValue != 1) return Plugin_Continue;
