...
{
    name = "L4D2 Ready-Up for Angel Beats!",
    author = "CanadaRox, Target",//origin author
    description = "New and improved ready-up plugin with optimal for convenience.",
    version = PLUGIN_VERSION,
    url = "https://github.com/Target5150/MoYu_Server_Stupid_Plugins"//you should know the initiated url
};
