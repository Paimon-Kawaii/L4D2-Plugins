 ...
 * @Create Date: 2023-02-14 12:14:55
 * @Last Modified time: 2024-01-25 14:59:47
...
bool IsPinned(int client)
{
    if (IsSurvivor(client))
        if (GetEntPropEnt(client, Prop_Send, "m_tongueOwner", 0) > 0 || GetEntPropEnt(client, Prop_Send, "m_carryAttacker", 0) > 0 || GetEntPropEnt(client, Prop_Send, "m_pounceAttacker", 0) > 0 || GetEntPropEnt(client, Prop_Send, "m_pummelAttacker", 0) > 0 || GetEntPropEnt(client, Prop_Send, "m_jockeyAttacker", 0) > 0)
            return true;
    return false;
}
